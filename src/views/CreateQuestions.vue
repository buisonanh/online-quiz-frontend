...
<div class="container my-5" data-bs-theme="dark">
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card custom-card-bg border-0 shadow-lg p-4">
                ...
                <div v-for="(question, index) in questions" :key="index" class="card mb-3">
                    <div class="card-body">
                        ...
                        <button class="btn btn-outline-danger border-0 mt-2" @click="removeQuestion(index)">Remove Question</button>
                    </div>
                </div>
                <button class="btn btn-light w-50 mb-5" @click="addQuestion">Add Question</button>
                <button class="btn custom-submit-btn w-100" @click="submitQuestions">Submit Questions</button>
